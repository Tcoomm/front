import { configureStore, createAction, createSlice, createNextState, PayloadAction } from "@reduxjs/toolkit";
        ...
        builder
            ...
            .addDefaultCase((state, action) => {
                ...
                const newPresent = createNextState(state.present, (draft) =>
                    presentationReducer(draft as Presentation, action as any)
                );
