    ...
    <div className={s.menu} onContextMenu={(e) => e.preventDefault()}>
      ...
      <div className={s.row}>
        ...
        <div className={s.alignGroup}>
          <button className={s.alignBtn} onClick={() => onTextAlignChange("left")}>
            {t("textMenu.left")}
          </button>
          <button className={s.alignBtn} onClick={() => onTextAlignChange("center")}>
            {t("textMenu.center")}
          </button>
          <button className={s.alignBtn} onClick={() => onTextAlignChange("right")}>
            {t("textMenu.right")}
          </button>
        </div>
      </div>
      <div className={s.row}>
        ...
        <div className={s.alignGroup}>
          <button className={s.alignBtn} onClick={onToggleBold}>
            {t("textMenu.bold")}
          </button>
          <button className={s.alignBtn} onClick={onToggleItalic}>
            {t("textMenu.italic")}
          </button>
          <button className={s.alignBtn} onClick={onToggleUnderline}>
            {t("textMenu.underline")}
          </button>
        </div>
      </div>
